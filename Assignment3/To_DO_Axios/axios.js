...
document.addEventListener("DOMContentLoaded", () => {
    ...
    buttonTodo.addEventListener("click", async () => {
        ...
        if (editMode) {
            ...
            try {
                ...
                alert(`Status: ${response.status}, Item successfully edited!`);
            ...
            try {
                ...
                alert(`Status: ${response.status}, Item successfully added!`);
            } catch (error) {
    ...
    ulTodo.addEventListener("click", async (e) => {
        ...
        if (e.target.classList.contains("delete-btn")) {
            try {
                ...
                alert(`Status: ${response.status}, Item successfully deleted!`);
                li.remove();
            } catch (error) {
    ...
    deleteAllButton.addEventListener("click", () => {
        const confirmDelete = confirm("Are you sure that you want to delete all tasks ???");
        if (confirmDelete) {
            ulTodo.innerHTML = "";
